...
from qudpy_sjh.utils.spectroscopy import diagnose_uniform_time_axis, lab_frame_absorption_response
...
class SpectroscopyAbsorptionResponseTests(unittest.TestCase):
    ...
    def test_no_piecewise_dark_imports(self):
        import qudpy_sjh.utils.spectroscopy.absorption_spectra as spectra
