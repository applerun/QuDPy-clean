"""Windows DLL search-path bootstrap for Conda based scientific stacks."""
...
def bootstrap_conda_dll_paths() -> None:
    """Register the active Conda environment's DLL folders on Windows."""
