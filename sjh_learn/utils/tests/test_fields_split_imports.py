...
class FieldsSplitImportTests(unittest.TestCase):
	...
	def test_split_module_imports(self):
		from sjh_learn.utils.fields.field_series import FieldPhySeries
		from sjh_learn.utils.fields.lab_fields import FieldPhyRoot, TimeShiftedField
		from sjh_learn.utils.fields.specific.basic_fields import GaussianCarrierFieldPhysical
		from sjh_learn.utils.fields.specific.ta_fields import TAField
		from sjh_learn.utils.fields.specific.twodes_fields import TwoDESField
	...
	def test_basic_fields_are_not_reexported_from_lab_fields(self):
		import sjh_learn.utils.fields.lab_fields as lab_fields
	...
	def test_ta_helpers_are_not_reexported_from_field_series(self):
		import sjh_learn.utils.fields.field_series as field_series
